...
public class GraphicSheet {
     ...
     *
     * @param path the path to the graphicsheet image.
     */
     ...
     *
     * @param x the x-position of the graphic in the sheet.
     * @param y the y-position of the graphic in the sheet.
     ...
     * at (xx, yy).
     *
     * @param x  the x-position of the top-left of the graphic.
     * @param y  the y-position of the top-left of the graphic.
     * @param xx the x-position of the bottom-right of the graphic.
     * @param yy the y-position of the bottom-right of the graphic.
