...
public final class ColorUtils {
     ...
     * @param mix    the proportion of the blend. 0.5 is an even mix. <0.5 leans
     ...
     * @param environmentDarkFactor the darkness factor of the environment.
     ...
     *
     * @param color the colour the darken.
     ...
     *
     * @param pixels the array of pixels to find the average colour of.
