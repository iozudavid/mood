...
public class MultiplayerMenu {
	...
	public MultiplayerMenu(int screenHeight, int screenWidth){
		...
		this.ipText = new Text(GuiUtils.middleWidth(this.screenWidth, 100), GuiUtils.calculateHeight(this.screenHeight, 25), 100, 40, "Ip address", 25);
		...
		this.portText = new Text(GuiUtils.middleWidth(this.screenWidth, 50), GuiUtils.calculateHeight(this.screenHeight, 50), 50, 40, "Port", 25);
		...
		this.cancelButton = new Button(GuiUtils.middleWidth(this.screenWidth/2, 300), GuiUtils.calculateHeight(this.screenHeight, 80), 300, 40, "Cancel",21);
		this.connectButton = new Button((int)(GuiUtils.middleWidth(this.screenWidth/2, 300)+this.screenWidth/2), GuiUtils.calculateHeight(this.screenHeight, 80), 300, 40, "Connect",21);
