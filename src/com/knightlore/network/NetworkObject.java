...
public abstract class NetworkObject extends GameObject implements INetworkable {
    ...
    private final UUID objectUniqueID;
    private final NetworkObjectManager networkObjectManager = GameEngine.getSingleton().getNetworkObjectManager();
     ...
     *
     * @param remoteMethod: The name of the method to call on the remote object.
