...
public class NetworkObjectManager extends GameObject {
    ...
    public void removeNetworkObject(NetworkObject obj) {
        Iterator<Entry<UUID, Tuple<NetworkObject, byte[]>>> networkObjIt = this.networkObjects.entrySet().iterator();
        ...
        Iterator<Entry<UUID, Tuple<NetworkObject, Boolean>>> networkDiscObjIt = this.disconnectedObjects.entrySet().iterator();
    ...
    public void onUpdate() {
        ...
        for (Entry<UUID, Tuple<NetworkObject, byte[]>> t : networkObjects.entrySet()) {
            ...
            if (areStatesDifferent(newState, t.getValue().y)) {
